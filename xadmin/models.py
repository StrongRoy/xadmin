...
class Bookmark(models.Model):
    ...
    user = models.ForeignKey(AUTH_USER_MODEL,models.CASCADE, verbose_name=_(u"user"), blank=True, null=True)
...
class UserSettings(models.Model):
    user = models.ForeignKey(AUTH_USER_MODEL,models.CASCADE, verbose_name=_(u"user"))
